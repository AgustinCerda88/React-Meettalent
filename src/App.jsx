          ...
          <div className="App">
            <div className="App-header">
              <Routes>
                ...
                <Route
                  path="/restablecerContrasenaEmail"
                  element={<RestablecerContrasenaEmail />}
                />
                <Route
                  path="/restablecerContrasenaContrasena/:userId/:resetString"
                  element={<RestablecerContrasenaContrasena />}
                />
